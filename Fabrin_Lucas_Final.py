'''
Floor is lava - you die if you touch it
Platforms randomly spawn in and have to jump from one to one to stay alive
Every 5 seconds the platforms turn invisible for 2 seconds
